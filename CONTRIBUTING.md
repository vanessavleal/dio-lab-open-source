...
| `docs`         | Modifica a documentação do projeto.| `docs: update README.md`
| `style`        | Altera a aparência, sem modificar a funcionalidade.         | `style: add EFFECTNAME to COMPONENT`
| `refactor`     | Refatora o código sem alterar a funcionalidade.        | `refactor: refactor at CLASSNAME`
